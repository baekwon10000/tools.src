...
export function w3color(color, elmnt) {
...
function ncolToRgb(ncol, white, black) {
  var letter, percent, h; //, w, b; // fix warning - no-unused-vars
  h = ncol;
...
function ncsToRgb(ncs){
  var black, chroma, bc, percent, black1, chroma1, red1, factor1, blue1, red2, green1, green2, blue2, max, factor2, grey, r, g, b; 
...
function rgbToHsl(r, g, b) {
  ...
  //s = s; // fix warning - no-self-assign
  return {h : h, s : s, l : l};
}
